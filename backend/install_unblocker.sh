...
echo "开始下载文件……"
wget https://raw.githubusercontent.com/xingfu111/sh/main/requirements.txt -O requirements.txt
wget https://raw.githubusercontent.com/xingfu111/sh/main/unblocker_manager.py -O unblocker_manager.py
SERVICE_FILE="[Unit]
